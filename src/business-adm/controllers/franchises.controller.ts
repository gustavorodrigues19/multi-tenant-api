...
import { CreateFranchiseUseCaseInputDto } from '../dto/franchise-service.dto'
...
export default class FranchisesController {
  ...
  @Post()
  create(@Body() input: CreateFranchiseUseCaseInputDto) {
  ...
  update(
    @Param('id') id: string,
    @Body() input: CreateFranchiseUseCaseInputDto,
  ) {
